...
public class OkManager {
    ...
    public void asyncJsonObjectByUrl(String url,String parm ,final Fun4 callback) {
        RequestBody requestBody = RequestBody.create(JSON, parm);
    ...
    {
        OkHttpClient client = new OkHttpClient().newBuilder().sslSocketFactory(SSLSocketClientDS.getSSLSocketFactory()).hostnameVerifier(SSLSocketClientDS.getHostnameVerifier()).connectTimeout(60000, TimeUnit.MILLISECONDS)
                .readTimeout(60000, TimeUnit.MILLISECONDS)
                .build();
