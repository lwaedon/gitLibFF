...
//        mRecordController.setOnTouchListener(mOnVideoControllerTouchListener);
        mRecordController.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                isPress=!isPress;
                if (isPress){
                    mRecordController.setSelected(true);
                    mRecordController.setText("停止");
    ...
    private void initMediaRecorder() {
        ...
        String key = StringUtils.formatDate(System.currentTimeMillis(), "yyyy-MM-dd-HH-mm-ss");
